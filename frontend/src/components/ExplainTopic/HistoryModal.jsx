...
const HistoryModal = ({ show, onClose, explanations, loadExplanation, deleteExplanation }) => {
    if (!show) return null;
        ...
        <AnimatePresence>
            ...
            >
                ...
                >
                    ...
                    <h3 className="text-xl font-bold mb-4 text-center text-[var(--color-text)]">История объяснений</h3>
                    <ExplanationsList
